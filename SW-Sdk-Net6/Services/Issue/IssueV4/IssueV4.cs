...
namespace SW.Services.Issue
{
    public class IssueV4 : StampService
    {
        ...
        public IssueV4(string url, string user, string password, int proxyPort = 0, string proxy = null) : base (url, user, password, proxyPort, proxy)
        {
        }
        /// <summary>
        /// Crear una instancia de la clase IssueV4.
        ...
        /// <param name="proxyPort">Puerto Proxy.</param>
        /// <param name="proxy">Proxy.</param>
        public IssueV4(string url, string token, int proxyPort = 0, string proxy = null) : base(url, token, proxyPort, proxy)
        {
        }
        /// <summary>
        ...
        {
            return await StampServiceV1Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, null, pdf);
        }
        /// <summary>
        ...
        {
            return await StampServiceV1Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, email);
        }
        /// <summary>
        /// Servicio de Emisión Timbrado V4 de un CFDI en formato XML. Recibe un Custom ID y puede realizar el guardado del PDF.
        /// </summary>
        ...
        {
            return await StampServiceV2Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, null, pdf);
        }
        /// <summary>
        /// Servicio de Emisión Timbrado V4 de un CFDI en formato XML. Recibe un Custom ID y un array de correos para el reenvio del XML y el PDF.
        /// </summary>
        ...
        {
            return await StampServiceV2Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, email);
        }
        /// <summary>
        /// Servicio de Emisión Timbrado V4 de un CFDI en formato XML. Recibe un Custom ID y puede realizar el guardado del PDF.
        /// </summary>
        ...
        {
            return await StampServiceV3Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, null, pdf);
        }
        /// <summary>
        /// Servicio de Emisión Timbrado V4 de un CFDI en formato XML. Recibe un Custom ID y un array de correos para el reenvio del XML y el PDF.
        /// </summary>
        ...
        {
            return await StampServiceV3Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, email);
        }
        /// <summary>
        /// Servicio de Emisión Timbrado V4 de un CFDI en formato XML. Recibe un Custom ID y puede realizar el guardado del PDF.
        /// </summary>
        ...
        {
            return await StampServiceV4Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, null, pdf);
        }
        /// <summary>
        /// Servicio de Emisión Timbrado V4 de un CFDI en formato XML. Recibe un Custom ID y un array de correos para el reenvio del XML y el PDF.
        /// </summary>
        ...
        {
            return await StampServiceV4Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Issue, StampVersion.V4, customId, email);
        }
    }
}
