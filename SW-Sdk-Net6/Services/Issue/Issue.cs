...
namespace SW.Services.Issue
{
    public class Issue : StampService
    {
        ...
        public Issue(string url, string user, string password, int proxyPort = 0, string proxy = null) 
        ...
        /// <param name="proxyPort">Puerto Proxy.</param>
        /// <param name="proxy">Proxy.</param>
        public Issue(string url, string token, int proxyPort = 0, string proxy = null) 
