...
{
    public class StampV4Storage : StampV4StorageService
    {
        /// <summary>
        /// Crear una instancia de la clase StampV4Storage
        /// </summary>
        ...
        /// <summary>
        /// Servicio de Timbrado V4 Storage de un CFDI sellado en formato XML. Recibe un Custom ID y puede realizar el guardado del PDF. Obtiene los datos faltantes
        ...
        {
            return await StampStorageServiceV2Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Stamp, customId, null, pdf);
        }
        /// <summary>
        /// Servicio de Timbrado V4 Storage que recibe un Custom ID y un array de correos para el reenvio del XML y el PDF del CFDI. Obtiene los datos faltantes
        /// de la versión del Response cuando se obtiene un error por Custom ID duplicado.
        /// </summary>
        /// <param name="xml">String del CFDI sellado en formato XML.</param>
        /// <param name="customId">Identificador unico asignado al comprobante.</param>
        ...
        {
            return await StampStorageServiceV2Async(Encoding.UTF8.GetBytes(xml), isB64, StampAction.Stamp, customId, email);
        }
    }
}