...
namespace SW.Test.Services.StampTest
{
    ...
    public class StampV4Test
    {
        ...
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
        ...
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.User, BuildHelper.Password);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false, true);
            var response = await stamp.StampV4Async(xml, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("success"));
            Assert.IsNotNull(response.Data);
        ...
        [TestMethod]
        public async Task StampV4_Pdf_Success()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false, true);
        ...
        [TestMethod]
        public async Task StampV4_Email_Success()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false, true);
        ...
        [TestMethod]
        public async Task StampV4_B64_Pdf_Success()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
        ...
        [TestMethod]
        public async Task StampV4_B64_Email_Success()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", true, true);
        ...
        #region UT Error
        [TestMethod]
        public async Task StampV4_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, "Token");
        ...
        [TestMethod]
        public async Task StampV4_Auth_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.User, "Password");
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false, true);
            var response = await stamp.StampV4Async(xml, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("error"));
            Assert.IsTrue(response.Message.Contains("El token debe contener 3 partes"));
        ...
        [TestMethod]
        public async Task StampV4_WrongUrl_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlApi, BuildHelper.Token);
            var response = await stamp.StampV4Async(String.Empty, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("error"));
        ...
        [TestMethod]
        public async Task StampV4_WrongUrl_Auth_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlApi, BuildHelper.User, BuildHelper.Password);
            var response = await stamp.StampV4Async(String.Empty, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("error"));
            Assert.IsTrue(response.Message.Equals("404"));
            Assert.IsTrue(response.MessageDetail.Equals("Not Found"));
        ...
        [TestMethod]
        public async Task StampV4_InvalidUrl_Error()
        {
            var stamp = new StampV4(null, BuildHelper.Token);
            var response = await stamp.StampV4Async(String.Empty, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("error"));
        ...
        [TestMethod]
        public async Task StampV4_InvalidUrl_Auth_Error()
        {
            var stamp = new StampV4("This is an url.", BuildHelper.User, BuildHelper.Password);
            var response = await stamp.StampV4Async(String.Empty, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("error"));
            Assert.IsTrue(!String.IsNullOrEmpty(response.Message));
            Assert.IsTrue(!String.IsNullOrEmpty(response.MessageDetail));
        ...
        [TestMethod]
        public async Task StampV4_InvalidXml_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
        ...
        [TestMethod]
        public async Task StampV4_NotSignedXml_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false);
            var response = await stamp.StampV4Async(xml, Guid.NewGuid().ToString());
            Assert.IsTrue(response.Status.Equals("error"));
            Assert.IsTrue(!String.IsNullOrEmpty(response.Message));
            Assert.IsTrue(!String.IsNullOrEmpty(response.MessageDetail));
        ...
        [TestMethod]
        public async Task StampV4_InvalidCustomId_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false);
        ...
        [TestMethod]
        public async Task StampV4_InvalidEmail_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false);
        ...
        [TestMethod]
        public async Task StampV4_InvalidEmailCount_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false);
        ...
        [TestMethod]
        public async Task StampV4_CFDI3307_Error()
        {
            var stamp = new StampV4(BuildHelper.UrlService, BuildHelper.Token);
            var xml = await BuildHelper.GetCfdi("cfdi40.xml", false, true);
